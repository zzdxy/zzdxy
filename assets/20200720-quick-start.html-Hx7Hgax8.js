import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as c,o,c as l,a as n,d as s,b as t,e}from"./app-6uiVS-dn.js";const i="/assets/aacb76f5ffabbbc9ede23f683256be41-J2E8SIgE.webp",u="/assets/ba28cca59f160f88a2c5c0535fceeb2e-mHv2mV4_.webp",d="/assets/644f607ea9707de6d25f9dfafb4cfb96--Xn3bCfr.webp",k="/assets/2b5ad394c94ba5803bc2e894744d8ba7-ZUpGC2xc.webp",r="/assets/571f9bfe5b4baaab08ca1586f0e5ff6a-exVg8Ze2.webp",m="/assets/087f7db9a7249e900dde8c00df58dd8e-uEox4iBG.webp",v={},b=e(`<h1 id="入门实例" tabindex="-1"><a class="header-anchor" href="#入门实例" aria-hidden="true">#</a> 入门实例</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>上一篇文章中我们讲了什么是持久化以及 Mybatis 的相关简介，今天就来看看如何创建一个 Mybatis 入门实例以及如何利用 Mybatis 进行 CRUD。</p><h2 id="数据库准备" tabindex="-1"><a class="header-anchor" href="#数据库准备" aria-hidden="true">#</a> 数据库准备</h2><ol><li>首先，我们来创建一个数据库，用于后序步骤的使用；</li></ol><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">DATABASE</span> test<span class="token punctuation">;</span>
